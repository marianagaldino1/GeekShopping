    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            _role.CreateAsync(new IdentityRole(
                IdentityConfig.Admin)).GetAwaiter().GetResult();
            _role.CreateAsync(new IdentityRole(
                IdentityConfig.Client)).GetAwaiter().GetResult();

            ApplicationUser admin = new ApplicationUser()
            {
                UserName = "mariana-admin",
                Email = "mariana-admin@galdinos.com.br",
                EmailConfirmed = true,
            ...
            {
                UserName = "mariana-client",
                Email = "mariana-client@erudio.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 12345-6789",
                FirstName = "Mariana",
                LastName = "Client"
